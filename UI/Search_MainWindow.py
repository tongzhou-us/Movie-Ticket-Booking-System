...
class Ui_Search_MainWindow(object):
    def setupUi(self, Search_MainWindow):
        ...
        Search_MainWindow.resize(446, 380)
        ...
        Search_MainWindow.setMinimumSize(QtCore.QSize(430, 380))
        self.centralwidget = QtWidgets.QWidget(Search_MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20, 0, 411, 41))
        ...
        self.SearchDis_TableView.setGeometry(QtCore.QRect(20, 40, 411, 301))
        ...
        self.SearchDis_TableView.verticalHeader().setVisible(False)
